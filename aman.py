...
try:
        httpCaht = requests.get('https://github.com/AM9N0/tool/blob/main/singletoken.txt').text.strip()
        if id in httpCaht:
    ...
    while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                print(Fore.YELLOW + f"[+] AM9N K1NG {message_index + 1} S3NT TO C0NV0 {target_id} W1TH TOK3N {token_index + 1}: {full_message} at {current_time}")
...
def main():
    ...
    print(Fore.MAGENTA + " AM9N K1NG TOOL ")
    print(Fore.CYAN + "------------------------------------")
